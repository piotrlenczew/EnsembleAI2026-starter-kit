...
def retrieve_with_rerank(root_dir: str, prefix: str, suffix: str, extension: str, min_lines: int = 10, top_k: int = 5) -> list[str]:
    """
    Hybrid retrieval:
    BM25 + Dense Retriever → merge → Cross-Encoder reranker
    """
                ...
                try:
                    with open(file_path, 'r', encoding='utf-8') as f:
                        ...
                        if len(lines) >= min_lines:
                            ...
                            corpus_bm25_tokens.append(prepare_bm25_str(content))
    ...
    doc_embs = dense_model.encode(corpus_texts)
